...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listviewOD=findViewById(R.id.listviewOD);
        btnBackOD=findViewById(R.id.btnBackOD);

        btnBackOD.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        for (int i=0;i<order_details.length;i++){
            order_details[i]=new String[5];//map to 5 columns i.e multiline.xml layout
            ...
            if (strData[7].compareTo("medicine")==0){
                ...
                order_details[i][3]="Del:"+strData[4]+ " " +strData[5];//concatenate date and time here
            }
